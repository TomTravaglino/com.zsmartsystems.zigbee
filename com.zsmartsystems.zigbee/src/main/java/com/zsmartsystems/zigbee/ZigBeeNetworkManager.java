...
public class ZigBeeNetworkManager implements ZigBeeNetwork, ZigBeeTransportReceive {
    ...
    /**
     * Reinitialises the network. This will take the transport layer OFFLINE, and will return the
     * {@link ZigBeeNetworkState} to {@link ZigBeeNetworkState#INITIALISING}. {@link #startup(boolean)} must be called
     * to place the network back ONLINE. The system should be in the same state as if the {@link #initialize()} method
